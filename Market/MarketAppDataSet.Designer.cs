...
namespace Market {
    ...
    public partial class MarketAppDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Brand, int Quantity, string Model, string SerialNumber) {
...
namespace Market.MarketAppDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_SerialNumber = 1 AND [SerialNumber] IS NULL) OR ([SerialNumber] = @Original_SerialNumber)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Brand], [Quantity], [Model], [SerialNumber" +
                "]) VALUES (@Name, @Brand, @Quantity, @Model, @SerialNumber);\r\nSELECT Id, Name, B" +
                "rand, Quantity, Model, SerialNumber FROM Products WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Brand] = @Brand, [Quantity] = @Quantity, [Model] = @Model, [SerialNumber] = @SerialNumber WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_SerialNumber = 1 AND [SerialNumber] IS NULL) OR ([SerialNumber] = @Original_SerialNumber)));
SELECT Id, Name, Brand, Quantity, Model, SerialNumber FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Market.Properties.Settings.Default.MarketAppConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Brand, Quantity, Model, SerialNumber FROM dbo.Products";
        ...
        public virtual int Fill(MarketAppDataSet.ProductsDataTable dataTable) {
        ...
        public virtual MarketAppDataSet.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MarketAppDataSet.ProductsDataTable dataTable = new MarketAppDataSet.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MarketAppDataSet.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Brand, global::System.Nullable<int> Original_Quantity, string Original_Model, string Original_SerialNumber) {
        ...
        public virtual int Insert(string Name, string Brand, global::System.Nullable<int> Quantity, string Model, string SerialNumber) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Brand, global::System.Nullable<int> Quantity, string Model, string SerialNumber, int Original_Id, string Original_Name, string Original_Brand, global::System.Nullable<int> Original_Quantity, string Original_Model, string Original_SerialNumber, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Brand, global::System.Nullable<int> Quantity, string Model, string SerialNumber, int Original_Id, string Original_Name, string Original_Brand, global::System.Nullable<int> Original_Quantity, string Original_Model, string Original_SerialNumber) {
            return this.Update(Name, Brand, Quantity, Model, SerialNumber, Original_Id, Original_Name, Original_Brand, Original_Quantity, Original_Model, Original_SerialNumber, Original_Id);
        }
    }
